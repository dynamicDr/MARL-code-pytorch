...
class Runner_MAPPO_MPE:
    def __init__(self, args, env_name, number, seed):
        ...
        self.writer = SummaryWriter(log_dir='{}/runs/{}_{}_with_{}_agents_seed_{}'.format(self.current_dir,self.number,self.env_name, self.args.num_of_agents, self.seed))
    ...
    def evaluate_policy(self, ):
        ...
        np.save('{}/data_train/{}_{}_with_{}_agents_seed_{}.npy'.format(self.current_dir,self.number,self.env_name,self.args.num_of_agents, self.seed), np.array(self.evaluate_rewards))
